...
const char *TEST_1702A_READ_PON =
...
const char *TEST_1702A_READ_DATA =
...
const char *TEST_1702A_WRITE_PON =
	"Connect your multimeter negative (black) probe to a GND pin on the Arduino header.\r\n"
	"\r\n"
	"Check the following pins on the EPROM socket are within 5% of the specified values: \r\n"
	"\r\n"
...
const char *TEST_1702A_WRITE_PGM =
	"Connect your multimeter negative (black) probe to a GND pin on the Arduino header.\r\n"
	"\r\n"
	"Check the following pins on the EPROM socket are within 5% of the specified values: \r\n"
	"\r\n"
...
const char *TEST_1702A_WRITE_VDD =
	"Connect your multimeter negative (black) probe to a GND pin on the Arduino header.\r\n"
	"\r\n"
	"Check the following pins on the EPROM socket are within 5% of the specified values: \r\n"
	"\r\n"
...
const char *TEST_1702A_WRITE_AA =
	"Connect your multimeter negative (black) probe to a GND pin on the Arduino header.\r\n"
	"\r\n"
	"Check the following pins on the EPROM socket are within 5% of the specified values: \r\n"
	"\r\n"
...
const char *TEST_1702A_WRITE_55 =
	"Connect your multimeter negative (black) probe to a GND pin on the Arduino header.\r\n"
	"\r\n"
	"Check the following pins on the EPROM socket are within 5% of the specified values: \r\n"
	"\r\n"
